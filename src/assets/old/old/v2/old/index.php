...
<div class="content">
	<div class="overview"  id="home_div">
		...
		<div class="vertical_center">
			<div class="home_wrapper">
				...
				<p><a href="../">Old website! Click here to go to the new version</a></p>
				<hr width="50%" />
			</div>
		</div>
	</div>
	<div class="overview" id="about_div">
		...
		<div class="centered">
		 	<p><img id="profile_image_home" class="home_image" src="photos/profile.jpg" width="200px" height="200px"></p>
